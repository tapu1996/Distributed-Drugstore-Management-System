...
public class sell extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if(!id.equals(""))dout.writeUTF("store1sell");
 //ois.reset();
            dout.writeUTF(id);
           //  ois.reset();
           // String j1 = (String)ois.readObject();
         //   ois.reset();
           String j1 = (String)din.readUTF();      
            System.err.println(j1);
           // String j2 = (String)ois.readObject();
            String j2 = (String)din.readUTF();
            //ois.reset();
            System.err.println(j2);
            //String j3 = (String)ois.readObject();
            String j3 = (String)din.readUTF();
             //ois.reset();
            System.err.println(j3);
           //String j4 = (String)ois.readObject();
            String j4 = (String)din.readUTF();
             //ois.reset();
            System.err.println(j4);
          //  String j5 = (String)ois.readObject();
            String j5 = (String)din.readUTF();
          //  ois.reset(); 
           System.err.println(j5);
            //String j6 = (String)ois.readObject();
            String j6 =(String) din.readUTF();
            // ois.reset();
            System.err.println(j6);

            
            jTextField1.setText(j1);
            jTextField2.setText(j2);
            jTextField3.setText(j3);
            jTextField4.setText(j4);
            jTextField5.setText(j5);
            jTextField7.setText(j6);
            s.close();
            din.close();
            dout.close();
